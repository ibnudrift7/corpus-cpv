...
<section class="contact-sec-2">
    <div class="prelative container">
		...
		<div class="row w-100 pt-4">
            ...
            $criteria->addCondition('t.feature = "1"');
			$m_address = Address::model()->findAll($criteria);
			?>
        ...
        <div class="row w-100 pt-2">
            ...
            $criteria2->addCondition('t.feature != "1"');
            $m_address2 = Address::model()->findAll($criteria2);
            ?>
            <?php foreach ($m_address2 as $key => $value): ?>
				<div class="col-md-30">
					<div class="kartu-contact">
						<div class="row no-gutters">
							<div class="col-md-30">
